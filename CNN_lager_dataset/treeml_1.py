...
Original file is located at
    https://colab.research.google.com/drive/1QN5LL1j267WKmfSSY9IqHONOjfwdDDq7
"""
...
splitfolders.ratio("/content/drive/My Drive/CNN_lager_dataset/dataset", 
                    output="/content/drive/My Drive/CNN_lager_dataset/dataset-division", 
...
def create_predictions():
    ...
    df.to_csv('prediction_names_list.csv', index=False)
    print("The prediction_names_list.csv has been generated and stored in the file directory.")
