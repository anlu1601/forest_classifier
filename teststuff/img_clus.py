...
class image_clustering:
	...
	def __init__(self, folder_path="data", n_clusters=10, max_examples=None, use_imagenets=False, use_pca=False):
		...
		os.makedirs("output", 777)
		for i in range(self.n_clusters):
			os.makedirs("output\\cluster" + str(i), 777)
	...
	def clustering(self):
		...
		#print(predictions)
		print(self.folder_path+self.image_paths[0], "output\\cluster"+str(predictions[0]))
		pathsss = r"C:/Users/André/Desktop/master_forest_clas/forest_classifier/teststuff/output/"
		print(pathsss)
		for i in range(self.max_examples):
			shutil.copy2(self.folder_path+self.image_paths[i], pathsss + "cluster"+str(predictions[i]) + "/")
		print("\n Clustering complete! \n\n Clusters and the respective images are stored in the \"output\" folder.")

	def tetes(self):
		pathsss = r"C:/Users/André/Desktop/master_forest_clas/forest_classifier/teststuff/output/"
		try:
			shutil.copy2(self.folder_path + self.image_paths[0], pathsss + "cluster0")
		except:
			print("fail")
...
if __name__ == "__main__":
	...
	number_of_clusters = 2 # cluster names will be 0 to number_of_clusters-1

	#data_path = r"C:/Users/André/Desktop/master_forest_clas/forest_classifier/teststuff/imgs/" # path of the folder that contains the images to be considered for the clustering (The folder must contain only image files)
	data_path = "./imgs/"
